...
async function submitOrder(){
  ...
  const submitButtons=[...document.querySelectorAll('button')].filter(b =>
    (b.getAttribute('onclick')||'').includes('submitOrder') ||
    /оформить|заказ/i.test(b.textContent||'')
  );
